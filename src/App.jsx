    ...
    <main className='contenedor-principal'>
      ...
      <section className='galeria-empleados'>
        ...
        <UserCard
         ...
         imagen='https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=100&q=80'
        />

        <UserCard
         nombre='Laura Gómez'
         profesion='DevOps Enginner'
         imagen='https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&q=80'
        />
